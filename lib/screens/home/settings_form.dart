...
class _SettingsFormState extends State<SettingsForm> {
  ...
  Widget build(BuildContext context) {
    ...
    final user = Provider.of<User>(context); //access the user that is logged in
            ...
            child: Column(
              children: <Widget>[
                ...
                DropdownButtonFormField(
                  ...
                  value: _currentSugars ?? userData.sugars,// value showed
                  items: sugars.map((sugar){
                    return DropdownMenuItem(
                      value: sugar, //track selected value
